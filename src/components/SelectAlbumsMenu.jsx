        ...
        return(
            <div className="menu-screen">
                ...
                >
                    ...
                    Crystal Castles |
                    <div className={"menu-album-checkout" + (this.props.albumsFilter[0] == true ? " menu-album-checkout-selected" : "")}></div>
                </div>
                ...
                >
                    ...
                    Crystal Castles ||
                    <div className={"menu-album-checkout" + (this.props.albumsFilter[1] == true ? " menu-album-checkout-selected" : "")}></div>
                </div>
                ...
                >
                    ...
                    Crystal Castles |||
                    <div className={"menu-album-checkout" + (this.props.albumsFilter[2] == true ? " menu-album-checkout-selected" : "")}></div>
                </div>
            </div>
        )
